...
data:extend({
    {
        type = "recipe",
        name = "cube-processing-plant",
        category = "forge-crafter",
        energy_required = 30,
        enabled = true,
    ...
    },
    {
        ...
        place_result = "cube-processing-plant",
        stack_size = 25,
    },

    {
        ...
        minable = { mining_time = 1, result = "cube-processing-plant" },
            ...
            working_visualisations = {
                {
                    ...
                    animation = {
                        filename =
                        "__Krastorio2Assets__/buildings/matter-associator/matter-associator-working-glow-light.png",
                        priority = "high",
                        width = 144,
                        height = 110,
                        frame_count = 30,
                ...
                },
                {
                    animation = {
                        layers = {
                            {
                                filename =
                                "__Krastorio2Assets__/buildings/matter-associator/matter-associator-working-light.png",
                                priority = "high",
                                width = 473,
                                height = 489,
                                frame_count = 30,
                            ...
                            {
                                filename =
                                "__Krastorio2Assets__/buildings/matter-associator/matter-associator-working.png",
                                priority = "high",
                                width = 473,
                                height = 489,
                                frame_count = 30,
        ...
        circuit_connector = circuit_connector_definitions.create_vector(
            ...
            {
                { variation = 2, main_offset = util.by_pixel(90, -105), shadow_offset = util.by_pixel(88, -105), show_shadow = false },
                { variation = 2, main_offset = util.by_pixel(90, -105), shadow_offset = util.by_pixel(88, -105), show_shadow = false },
                { variation = 2, main_offset = util.by_pixel(90, -105), shadow_offset = util.by_pixel(88, -105), show_shadow = false },
                { variation = 2, main_offset = util.by_pixel(90, -105), shadow_offset = util.by_pixel(88, -105), show_shadow = false }
            }
