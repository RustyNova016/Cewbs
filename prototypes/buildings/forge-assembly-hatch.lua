...
data:extend({
    {
        ...
        crafting_categories = { "forge-crafter" },
        crafting_speed = 1.0,
        ingredient_count = 6,
        module_slots = 4,
        ...
        graphics_set = {
            animation = {
                layers = {
                    {
                        filename = "__ultradense-forge__/graphics/entity/forge-assembly-hatch/forge-assembly-hatch.png",
                        priority = "high",
                        width = 473,
                        height = 489,
                        frame_count = 1,
            ...
            working_visualisations = {{
                animation = {
                    layers = {
                        {
                            filename =
                            "__ultradense-forge__/graphics/entity/forge-assembly-hatch/forge-assembly-hatch.png",
                            priority = "high",
                            width = 473,
                            height = 489,
                            frame_count = 1,
