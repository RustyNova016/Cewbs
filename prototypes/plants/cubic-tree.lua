local tech_tree = util.merge({
    data.raw["plant"]["yumako-tree"],
    {
        name = "udf-tech-tree",
        autoplace =
        {
            ...
            tile_restriction = { "udf-core-flux" }
        },
        minable = {
            results = { { type = "item", name = "cubic-fruit", amount = 1 } },
        }
    }
});
tech_tree.collision_mask = { layers = {} }
